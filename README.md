...
Dataset
==========
The input data can be found via [kaggle's page](https://www.kaggle.com/c/msk-redefining-cancer-treatment/data). Copy the input files into the folder 'data'. The necesesary files in other folders including 'pre_define' will be generated by running the code at the first time.
